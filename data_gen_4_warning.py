# This shit will generate 5 million images. If you're sane DON'T RUN IT
...
def apply_morphology(img: Image.Image, kernel_size: int, type: str) -> Image.Image:
    ...
    # Note: kernel_size is fixed at 1 for subtle effect
    if type == "erode":
...
def generate_augmentations(base_img: Image.Image, config: dict, num_images_per_chain: int) -> tuple[int, list[Image.Image]]:
    ...
    This replaces the previous single-effect and hardcoded 3-step chained generators.
    ...
    for length in range(1, MAX_CHAIN_LENGTH + 1):
        ...
        # Example: length 2 generates (R,R), (R,S), (S,R), (S,S), (Z,M), etc.
...
def augment_pipeline(base_images):
    ...
    for base_img in base_images:
        ...
        # --- PHASE 2: Noise on ALL Transformed Images (Applies noise to all of Phase 1) ---
